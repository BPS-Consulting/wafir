                    ...
                    content: {
                        "application/json": {
                            ...
                            tabs?: {
                                ...
                                isFeedback: boolean;
                                /**
                                 * @description If true, the current date and time will be automatically inserted into the issue body in a human-readable format
                                 * @default false
                                 */
                                currentDate: boolean;
                                /** @description Form fields for this tab. Can be an array of field objects or a URL to a GitHub Issue Form YAML template. If omitted, defaults are used for known tab IDs. */
                                fields?: {
                                    /**
